  ...
  return (
    <PlayerProvider>
      <div className="flex flex-col min-h-0 min-w-0 h-full w-full overflow-hidden">
        ...
        {/* Contenedor fijo en la parte inferior - Solo mostrar si el usuario está autenticado */}
        {isLoggedIn && (
        ...
        {/* Mostrar banner de registro si no hay sesión - visible en todas las pantallas */}
        {!isLoggedIn && (
        ...
        {/* Menú inferior solo para usuarios autenticados */}
