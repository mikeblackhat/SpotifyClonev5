...
const UserMenu = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Redirigir de todos modos después de un breve retraso
      setTimeout(() => {
        ...
        {!isLoading && !session ? (
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden md:flex items-center gap-2">
              {/* Mostrar botón de Premium solo a usuarios con plan free */}
              ...
              <button 
                ...
                className="bg-neutral-800 text-white px-3 py-1.5 rounded-full hover:bg-neutral-700 transition flex items-center gap-2"
                aria-label="Descargar aplicación"
                title="Descargar aplicación"
              >
                <GrInstallOption size={16} />
