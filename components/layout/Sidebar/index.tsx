...
const Sidebar: React.FC = () => {
    ...
    if (!isAuthenticated) {
        ...
        initial={{ width: 280 }}
        animate={{ 
            width: 280, // Ancho expandido por defecto
            transition: { 
                type: 'spring', 
                stiffness: 300,
                damping: 30,
        ...
        // Eliminamos el whileHover para mantener el ancho fijo
    >
        <motion.div 
        ...
        >
            ...
            >
                <h3 className="text-lg font-bold text-white block">Tu biblioteca</h3>
