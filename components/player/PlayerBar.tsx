...
const PlayerBar: React.FC = () => {
  ...
  if (!currentSong) {
    return null; // No mostrar la barra de reproducción si no hay canción
  }

  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-gray-900 to-black border-t border-gray-800 p-3 z-50">
